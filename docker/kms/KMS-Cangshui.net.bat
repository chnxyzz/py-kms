...
:start2
set KMS_Sev=kms.dopwn.com
cls
echo 正在检查本机网络情况耐心等待
echo.
ping kms.dopwn.com | find "超时"  > NUL &&  goto fail
ping kms.dopwn.com | find "目标主机"  > NUL &&  goto fail
echo 本机网络良好……
goto office
...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:kms.dopwn.com >nul
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms kms.dopwn.com
